...
var config = {
  ...
  endpoints: {
    api: 'api.stage.quickblox.com',
    chat: 'chatstage.quickblox.com',
    muc: 'muc.chatstage.quickblox.com',
    turn: 'turnserver.quickblox.com',
    s3Bucket: 'qbprod'
  },
  chatProtocol: {
    //bosh: 'http://chat.quickblox.com:8080',
    bosh: 'https://chatstage.quickblox.com:8081', // With SSL
    websocket: 'ws://chatstage.quickblox.com:5290',
    active: 2
  },
  urls: {
    session: 'session',
