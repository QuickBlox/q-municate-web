...
DialogProxy.prototype.update = function(id, params, callback) {
  ...
  this.service.ajax({url: Utils.getUrl(dialogUrl, id), type: 'PUT', data: JSON.stringify(params), contentType: 'application/json; charset=utf-8'}, callback);
};
