...
function ChatProxy(service) {
  ...
  this._onMessage = function(stanza) {
    ...
    console.log(extraParams[0]);
    // custom parameters
    if (extraParams) {
      console.log(extraParams.children);
      for (var i = 0, len = extraParams.children.length; i < len; i++) {
        // extraParams.children.forEach(function(elem) {
          console.log(extraParams.children[i]);
          console.log(extraParams.children[i].tagName);
          console.log(extraParams.children[i].textContent);
